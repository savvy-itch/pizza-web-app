...
function createCustomPizzaCard() {
  ...
  let content = `
    <img class="create-pizza-img" height="309" width="300" src="../images/create-pizza.webp" alt="create-pizza">
...
function createPizzaCard(item) {
  ...
  let pizzaContent = `
    ...
    <img height="220" width="241" src=${item.imgUrl} loading="lazy" alt="pizza">
